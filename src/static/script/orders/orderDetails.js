        ...
        button.addEventListener('click', function () {
            ...
            fetch(`/orders/${orderId}`)
                ...
                .then(data => {
                    ...
                    document.getElementById('detail-delivery-date').textContent = convertToJalali(order.delivery_date);
                    document.getElementById('detail-exit-from-office-date').textContent = convertToJalali(order.exit_from_office_date);
                    document.getElementById('detail-exit-from-factory-date').textContent = convertToJalali(order.exit_from_factory_date);
                    document.getElementById('detail-created-at').textContent = order.created_at ? convertToJalali(order.created_at) : '';
